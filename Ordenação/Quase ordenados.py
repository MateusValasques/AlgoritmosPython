...
for i in range (50):
    vet2.append(i)
for i in range (50):
    vet2.append(random.randrange(50))
...
for i in range (500):
    vet3.append(i)
for i in range (500):
    vet3.append(random.randrange(500))
...
for i in range (5000):
    vet4.append(i)
for i in range (5000):
    vet4.append(random.randrange(5000))
...
for i in range (50000):
    vet5.append(i)
for i in range (50000):
    vet5.append(random.randrange(50000))
...
for i in range (500000):
    vet6.append(i)
for i in range (500000):
    vet6.append(random.randrange(500000))
